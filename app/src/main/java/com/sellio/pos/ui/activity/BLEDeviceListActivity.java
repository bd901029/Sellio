...
public class BLEDeviceListActivity extends ListActivity {
...
//	private static final UUID SPP_UUID = UUID.fromString("8ce255c0-200a-11e0-ac64-0800200c9a66");
	...
	private int initDevicesList() {
		...
		mArrayAdapter = new ArrayAdapter<String>(getApplicationContext(), R.layout.layout_ble_device_list);
	...
	private final BroadcastReceiver mBTReceiver = new BroadcastReceiver() {
		...
		public void onReceive(Context context, Intent intent) {
			...
			if (BluetoothDevice.ACTION_FOUND.equals(action)) {
				...
				try {
					if (btDevices == null) {
						btDevices = new ArrayAdapter<BluetoothDevice>(getApplicationContext(), R.layout.layout_ble_device_list);
					}
